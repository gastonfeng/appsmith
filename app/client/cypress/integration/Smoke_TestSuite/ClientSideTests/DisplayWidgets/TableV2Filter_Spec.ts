...
describe("Verify various Table_Filter combinations", function () {
  ...
  it.skip("12. Verify Table Filter for 'not empty'", function () {
  ...
  it.only("30. Import TableFilter application & verify all filters for same FirstName (one word column) + Bug 13334", () => {
